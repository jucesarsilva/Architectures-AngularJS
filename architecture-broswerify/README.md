...
```
git clone https://github.com/jucesarsilva/S2It.git
cd S2it
```
...
```bash
git clone --depth=1 https://github.com/jucesarsilva/S2It.git <your-project-name>
```
...
app/                    --> all of the source files for the application
  ...
  components/           --> all app specific modules
    ...
    directives/              --> directives
      directives.js              --> module for directives centralization 
    filters/                 --> filters
      filters.js                 --> module for filters centralization
    services/                 --> services
      services.js                --> module for services centralization
